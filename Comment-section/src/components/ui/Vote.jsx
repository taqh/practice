	...
	return (
		<div className='vote h-fit bg-LightGray dark:bg-Vote flex md:flex-col gap-2 items-center justify-center p-2 w-fit rounded-lg transition duration-300'>
			<Button
				...
				className={` ${props.user && 'pointer-events-none cursor-not-allowed'} w-5 h-5 justify-center flex items-center fill-[#C5C6EF] hover:fill-ModerateBlue dark:hover:fill-Blueish`}
			>
				<PlusIcon />
			</Button>
