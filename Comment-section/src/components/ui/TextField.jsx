...
const TextField = ({ onSubmit }) => {
	...
	return (
		<form
			...
			className='textfield grid gap-3  bg-white dark:bg-Gray p-5 rounded-lg shadow-sm transition'
		>
			...
			<textarea
				...
				className='resize-none input dark:bg-TextArea dark:text-PaleBlue dark:caret-SoftBlue border rounded-lg caret-ModerateBlue cursor-pointer hover:border-ModerateBlue focus-within:outline-ModerateBlue focus:border-transparent transition px-4 py-2.5'
				rows={3}
				value={handler.value}
